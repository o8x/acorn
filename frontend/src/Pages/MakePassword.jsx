...
import {Button, Checkbox, Form, Input, InputNumber, Segmented, Tooltip} from "antd"
...
export default function () {
    ...
    function makePass() {
        ...
        opts = shuffleList(opts.concat(otherPart.split("")))
    ...
    return <Container title="密码生成" subTitle="随机生成指定长度的密码">
        ...
        >
            ...
            <Form.Item label="长度">
                <Segmented value={length} onChange={setLength} options={[8, 16, 24, 32, 40, 64, 128]}/>
                <InputNumber style={{marginLeft: 10}} onChange={setLength} value={length}/>
            </Form.Item>
